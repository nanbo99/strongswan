...
struct ietf_swima_attr_sw_ev_t {
	 ...
	 */
	void (*set_last_eid)(ietf_swima_attr_sw_ev_t *this, uint32_t last_eid);
	 ...
	 */
	uint32_t (*get_last_eid)(ietf_swima_attr_sw_ev_t *this,
							 uint32_t *eid_epoch, uint32_t *last_eid);
 ...
 * @param eid_epoch			Event ID Epoch
 * @param eid				Sets Last Evend ID and Last Consulted Event ID
